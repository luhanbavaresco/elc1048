    ...
    for (;;)
    {
        ...
        if (i > 0)
        {
            ...
            { /// Caso a temperatura atinja valor superior a 29, codifica os valores de temperatura
                ...
                lcd.clear();
                lcd.setCursor(0, 0);
                lcd.print("Temp Ambiente "); // Exibe o valor de temperatura no display.
                lcd.setCursor(0, 1);
                lcd.print("Congelante!!!"); // Escreve “C” para dizer que a escala é Celsius.
                lcd.setCursor(0, 2);
